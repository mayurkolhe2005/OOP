...
int main() {
/*float a, b, c, d;
cout << "Enter first complex number(real no. then imaginary no.): " << endl;
cin >> a >> b;
complex C1(a, b);
cout << "C1 = ";
C1.display();
cout << "Enter second complex number(real no. then imaginary no.): " << endl;
cin >> c >> d;
complex C2(c, d);
cout << "C2 = ";
C2.display();*/
...
Output:
Enter values for first Complex no.:
Enter the real part: 2
Enter the imaginary part: 3
Enter values for second Complex no.:
